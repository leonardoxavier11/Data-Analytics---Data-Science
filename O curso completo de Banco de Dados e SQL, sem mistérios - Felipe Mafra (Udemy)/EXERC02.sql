...
SELECT COUNT(*) FROM FUNCIONARIOS; -- CONTAR QUANTOS REGISTROS TEM NA TABELA

SELECT COUNT(*), DEPARTAMENTO FROM FUNCIONARIOS GROUP BY departamento ORDER BY 1; -- CONTAR NUMEROS DE FUNCIONARIOS POR DEPARTAMENTO E ORDENAR PELA PRIMEIRA COLUNA
SELECT NOME FROM FUNCIONARIOS WHERE departamento = 'ROUPAS' OR departamento = 'FILMES'; -- (OR -> TEM MAIS ROUPAS QUE FILME)

SELECT COUNT(*), SEXO FROM FUNCIONARIOS GROUP BY SEXO ORDER BY 1; -- CONTAR NUMEROS DE FUNCIONARIOS POR GENERO
SELECT NOME,EMAIL FROM FUNCIONARIOS WHERE (DEPARTAMENTO = 'LAR' OR DEPARTAMENTO = 'FILMES') AND SEXO = 'FEMININO'  ; -- (AND -> TEM MENOS FUNCIONARIOS EM LAR/FILMES .. OR -> TEM MAIS LAR QUE FILMES)
SELECT NOME,EMAIL FROM FUNCIONARIOS WHERE (DEPARTAMENTO = 'LAR' AND SEXO = 'FEMININO') OR (DEPARTAMENTO = 'FILMES' AND SEXO = 'FEMININO'); -- (RESPOSTA DO PROFESSOR)

SELECT COUNT(*), sexo FROM FUNCIONARIOS WHERE SEXO = 'MASCULINO'; -- CONTAR NUMEROS DE FUNCIONARIOS DO SEXO MASCULINO
